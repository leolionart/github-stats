...
class Queries(object):
    ...
    async def query(self, generated_query: str, variables: dict = {}) -> Dict:
        """
        ...
        """
        _json = {"query": generated_query}
        if variables: _json.update({'variables': variables})
        try:
    ...
    async def get_stats(self) -> None:
        ...
        while True:
            raw_results = await self.queries.query(
                REPOS_OVERVIEW, {
                    'ownedCursor': next_owned,
                    'contribCursor': next_contrib,
                }
            )
        ...
        # Improve languages to scale by number of contributions to
        # specific filetypes
